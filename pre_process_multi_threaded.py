...
onlyfiles = [f for f in listdir('txtData/') if isfile(join('txtData/', f))]
...
def files(name):
    ...
    tokens = [x for x in l if not re.fullmatch('[' + string.punctuation + ']+'
                                               , x)]

    words = [word.lower() for word in tokens]
    med_remove =['a', 'about', 'all', 'almost', 'also', 'although', 'always',
                 'among', 'an', 'and', 'another', 'any', 'are', 'as', 'at',
                 'be', 'because', 'been', 'being', 'between', 'both', 'but',
                 'by','can', 'could','did', 'do', 'does', 'done', 'due',
                 'each', 'either', 'enough', 'especially', 'etc','for',
                 'found', 'from', 'further','had', 'has', 'have', 'having',
                 'here', 'how', 'however', 'i', 'if', 'in', 'into', 'is',
                 'it', 'its', 'itself','just','kg','km','made', 'mainly',
                 'make', 'may', 'mg', 'might', 'ml', 'mm', 'most', 'mostly',
                 'must','nearly', 'neither', 'nor','obtained', 'of', 'often',
                 'on', 'our', 'overall','perhaps', 'pmid','quite','rather',
                 'really', 'regarding', 'seem', 'seen', 'several', 'should',
                 'show', 'showed', 'shown', 'shows', 'significantly',
                 'since', 'so', 'some', 'such', 'than', 'that', 'the',
                 'their', 'theirs', 'them', 'then', 'there', 'therefore',
                 'these', 'they', 'this', 'those', 'through', 'thus', 'to',
                 'upon', 'use', 'used', 'using','various', 'very','was',
                 'we', 'were', 'what', 'when', 'which', 'while', 'with',
                 'within', 'without', 'would']

    new_stopwords = set(stopwords.words('english')+med_remove) - {'after',
                       'again','before','no','during','not'}
    ...
    final = ret.rstrip()
    buff = open("preprocessed/"+str(name)+'.txt', "w")
    buff.write(final)
    buff.close()
